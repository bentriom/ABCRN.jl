...
b1 = @benchmark for i=1:$(nb_sim) BiochemNetABC.simulate($ER) end
#b2 = @benchmark for i=1:$(nb_sim) BiochemNetABC.simulate(ER) end
...
ER.buffer_size = 100
b1_100 = @benchmark for i=1:$(nb_sim) BiochemNetABC.simulate($ER) end
#b2_100 = @benchmark for i=1:$(nb_sim) BiochemNetABC.simulate(ER) end
